...
`bryanunitek/UniSaaS.UniCORE.BIND9` is the **BIND9** family member: SaaS-deployment-shape public gift surface. Documentation today; source code at certification.

**Family purpose:** Open-source authoritative + recursive DNS — primary DNS substrate for UniCORE.GVB nodes.

**Deployment shape:** This is the **SaaS-shape** member of the family. It tracks the same upstream codebase as [`UniCORE.BIND9`](https://github.com/bryanunitek/UniCORE.BIND9) (on-prem shape) but carries SaaS-specific configuration, multi-tenant isolation patterns, and cloud-native deployment artefacts.
...
- `bryanunitek/UniCORE.BIND9` — public on-prem-deployment-shape gift surface
- `bryanunitek/UniSaaS.UniCORE.BIND9` — public SaaS-deployment-shape gift surface ← **this repo**
...
- **Public discussion:** [GitHub Discussions](https://github.com/bryanunitek/UniSaaS.UniCORE.BIND9/discussions)
